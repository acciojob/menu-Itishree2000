  ...
  return (
    <main id='main'>
      ...
      <div className="categories">
        ...
        <button id="filter-btn-1" onClick={() => filterDishesByCategory('Breakfast')}>Breakfast</button>
        <button id="filter-btn-2" onClick={() => filterDishesByCategory('Lunch')}>Lunch</button>
        <button id="filter-btn-3" onClick={() => filterDishesByCategory('Shakes')}>Shakes</button>
      </div>
